...
import io.defitrack.protocol.farming.HopPolygonFarmingMarketProvider
...
@Component
class HopPolygonClaimableRewardProvider(
    private val marketProvider: HopPolygonFarmingMarketProvider,
