...
@Configuration
class OptimismWeb3jConfigurer(@Value("\${io.defitrack.optimism.endpoint.url}") private val endpoint: String) {
    protected var webSocketClient: WebSocketClient? = null
    val logger: Logger = LoggerFactory.getLogger(OptimismWeb3jConfigurer::class.java)
