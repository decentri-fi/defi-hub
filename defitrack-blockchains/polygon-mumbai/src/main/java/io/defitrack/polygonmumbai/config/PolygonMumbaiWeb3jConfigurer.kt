...
@Configuration
class PolygonMumbaiWeb3jConfigurer(@Value("\${io.defitrack.polygon-mumbai.endpoint.url}") private val endpoint: String) {


    protected var webSocketClient: WebSocketClient? = null

    val logger: Logger = LoggerFactory.getLogger(PolygonMumbaiWeb3jConfigurer::class.java)
